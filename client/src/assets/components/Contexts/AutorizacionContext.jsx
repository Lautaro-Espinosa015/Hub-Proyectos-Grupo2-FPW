...
export const AutorizacionProvider = ({ children }) => {
  ...
  const login = (username, password) => {
    ...
    const admin = adminUsers.find(u => u.username.toLowerCase() === normalizedUsername);
    ...
    const user = registeredUsers.find(u => u.username.toLowerCase() === normalizedUsername);
  ...
  const register = (username, password) => {
    ...
    const isRegistered = registeredUsers.some(u => u.username.toLowerCase() === normalizedUsername);
